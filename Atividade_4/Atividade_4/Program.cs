...
namespace Atividade_4
{
    class Program
    {
        ...
        static List<int> lerArquivo1()
        {
            ...
            try
            {
                StreamReader arquivo = new StreamReader("D:\\Arquivo1.txt");
        ...
        static void gravarArquivo1(List<int> listNumeros)
        {
            try
            {
                StreamWriter arquivo = new StreamWriter("D:\\Arquivo1.txt");
        ...
        static void gravarArquivo2()
        {
            try
            {
                StreamWriter arquivo = new StreamWriter("D:\\Arquivo2.txt");
        ...
        static void lerArquivo2()
        {
            ...
            try
            {
                StreamReader arquivo = new StreamReader("D:\\Arquivo2.txt");
                line = arquivo.ReadLine();
                while (line != null)
                {
                    Console.WriteLine(line);
